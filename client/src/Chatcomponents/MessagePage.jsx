...
//           <header className='sticky top-0 h-16 bg-white flex justify-between items-center px-4'  style={{color:'white',backgroundColor: '#006756' }} >
...
//               <div >
//               <button className='cursor-pointer hover:text-primary mx-2'>
//                       <FaPhone/>
//                     </button>
//               <button className='cursor-pointer hover:text-primary mx-4'>
//                       <FaVideo/>
//                     </button>
