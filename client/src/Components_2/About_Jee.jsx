...
import aboutjee from './About_jee.png'
    ...
    <div>
      <div className="outerabouthero">
        <div className="innerabouthero">
            <div className="secc1">
                <h1 className="aboutheading my-4 text-center">About Writo Student Community for JEE students</h1>
            ...
            <div className="secc2">
            <img src={aboutjee} className="aboutheroimage" alt="..." />
